...
public class JspController{
	...
	public String method02 (HttpServletRequest request, MultipartFile file,String username,String regSex,int userage,String userEmail, Model model) throws Exception {
		//ModelAndView
		...
		Date date=new Date();
		perSet per = new perSet("username","userEmail","1",date,userage,regSex,"11",4);
		service.InsertByPerSet(per);
		//mav.addObject("info", "信息");
